...
class RepairRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repair_request" do
    assert_difference('RepairRequest.count') do
      post repair_requests_url, params: { repair_request: { email: @repair_request.email, name: @repair_request.name, phone_number: @repair_request.phone_number, problem: @repair_request.problem } }
    end
  ...
  test "should update repair_request" do
    patch repair_request_url(@repair_request), params: { repair_request: { email: @repair_request.email, name: @repair_request.name, phone_number: @repair_request.phone_number, problem: @repair_request.problem } }
